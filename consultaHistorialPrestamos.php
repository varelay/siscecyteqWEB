...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <ul>
        ...
        <li class="f"><a href="consultaHistorialPrestamos.php" style="color: yellowgreen; font-family: 'Pacifico', cursive; font-size: 1.3rem;"  class="active">Historial Prestamos</a></li>
...
<table id="tablax" class="table table-striped table-hover" style="text-align: center;">
    ...
    <tbody>
      <?php
        ...
        $query="select distinct alumno,DATE_FORMAT(fecha ,'%d/%m/%Y %h:%i %p') as fecha from tbhistprestamos";
        $query2="select * from tbhistprestamos";
       ...
       <tr>
         ...
         <div class="col mb-2">
            <a class="oculto" style="color: #04a9f0;" href="detallesprestarHerramientas.php?alumno=<?php echo $row['alumno'];?>&fecha=<?php echo $row['fecha'] ?>"><img src=imagenes/detalles.png>  Detalles</a><br>
         </div>
