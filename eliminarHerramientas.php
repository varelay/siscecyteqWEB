  ...
  <body>
    ...
    <!--Formulario index -->
            ...
            <form class="contenedorform"  action="funcionesBD.php?idherramienta=<?php echo $row['idherramienta'] ?>"  method="POST" enctype="multipart/form-data">
                    <center><h1 style="text-align: center; color:#4C7295;display:inline-block;">¿Desea eliminar <?php echo "<h1 style=color:red;display:inline-block; >".$row['herramienta']."</h1>" ?></h1><h1 style="display:inline-block; color:#4C7295; ">?</h1></center>
                    <br>
                  <div class="col text-center">
                     <button type="submit" name="btnborrarherramienta" class="btn btn-outline-danger" style="width: 150px; height: 60px; font-size: 1.1rem;">Si</button>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <button type="submit" name="btnCancelarborrarherramienta" class="btn btn-outline-success" style="width: 150px; height: 60px; font-size: 1.1rem;">No</button>
                  </div>
            </form>
