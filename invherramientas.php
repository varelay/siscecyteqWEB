...
<html lang="en" dir="ltr">
  ...
  <ul>
      ...
      <li class="f"><a href="invherramientas.php" style="color: yellowgreen; font-family: 'Pacifico', cursive; font-size: 1.3rem;" class="active">Menú de herramientas</a></li>
...
<h1>Inventario <span style="font-family: 'Pacifico', cursive; font-size: 4.5rem;" class="typer" id="some-id" data-delay="200" data-delim=":" data-words="Herramientas:Materiales" data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
...
<table id="tablax" class="table table-striped table-hover" style="text-align: center;">
    ...
    <tbody>
      <?php
        ...
        $query="select * from tbherramientas";
        $resultado=$conexion->query($query);
        while($row=$resultado->fetch_assoc()){
       ?>
       <tr>
         <td style="width:0%;"><?php echo $row['idherramienta'] ?></td>
         <td style="width:200px;height:25px;text-align:center;vertical-align: middle;"><?php echo $row['herramienta'] ?></td>
         <td style="width:100px;text-align:center;vertical-align: middle;"><?php echo $row['inv'] ?></td>
         <td style="text-align:center;vertical-align: middle;"><?php echo $row['cantidad'] ?></td>
         <td style="text-align:center;vertical-align: middle;"><?php echo $row['marca'] ?></td>
         <td style="text-align:center;vertical-align: middle;"><?php echo $row['observ'] ?></td>
         <td style="text-align:center;vertical-align: middle;"><img height="100px" src="data:image/jpg;base64,<?php echo base64_encode($row['Imagenh']); ?>"/></td>
         <td style="width:150px;text-align:center;vertical-align: middle;"><a class="oculto" style="color: red;" href="eliminarHerramientas.php?idherramienta=<?php echo $row['idherramienta']; ?>"><img src=imagenes/borrar.png>  Eliminar</a><br><br>
         <a class="oculto" style="color: black;" href="editarHerramientas.php?idherramienta=<?php echo $row['idherramienta']; ?>">   <img src="imagenes/actualizar.png">  Actualizar </a></td>
...
<form class="" action="funcionesBD.php" method="post">
  <button type="submit" name="btnAHerramienta" class="btn btn-primary btn-sm & centrado" style="width: 250px; height: 40px; font-size: 1.1rem;">Agregar Herramienta</button>
</form>
</div>
</div>
