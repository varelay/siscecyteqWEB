...
<html lang="en" dir="ltr">
  ...
  <h1>Material prestado a<span class="typer" id="some-id" data-delay="200" data-delim=":" data-words="..." data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
    <br>    
...
<table class="table table-striped table-hover" style="text-align: center;">
    ...
    <tbody>
      <?php
        include("conexion.php");
        $alumno=$_REQUEST['alumno'];
        $query="SELECT idPrestamo, alumno, DATE_FORMAT(fecha ,'%d/%m/%Y %h:%i %p') as fecha , quimico from tbprestamosquimi WHERE alumno='$alumno'";
       ...
       <tr>
         ...
         <td style="width:150px;text-align:center;vertical-align: middle;"><a class="oculto" style="color: green;" href="completarPrestamoQuimico.php?idPrestamo=<?php echo  $row['idPrestamo'] ?>&alumno=<?php echo $row['alumno']?> "><img src=imagenes/cheque.png>  Entregado</a></td>
...
<form class="" action="funcionesBD.php" method="post">
    <center>
     ...
     <button type="submit" name="btnAQuimicosPrestamo2" class="btn btn-primary btn-sm" style="width: 250px; height: 40px; font-size: 1.1rem;">Prestar más material</button>
     &nbsp;&nbsp;&nbsp;<button type="submit" name="btnVolverQuimicoPrestamo" class="btn btn-outline-primary" style="width: 250px; height: 40px; font-size: 1.1rem;">Volver</button>
    </center>
