...
<form class="" action="funcionesBD.php"  method="POST" enctype="multipart/form-data">
                                           ...
                                           <div>
                                           <center>
                                               <button type="submit" name="btnAAlumno" class="btn btn-primary btn-sm" style="width: 400px; height: 40px; font-size: 1.1rem;">Agregar Alumno</button>   
                                        </form>
                                        <form action="funcionesBD.php" method="post"><br>
                                        <button type="submit" name="btnVolverAAAlumno" class="btn btn-outline-primary" style="width: 400px; height: 40px; font-size: 1.1rem;">Volver</button>
                                         </form>
                                         </div>
                                           </center>
</div>
