...
<table class="table table-striped table-hover" style="text-align: center;">
    ...
    <tbody>
      <?php
        ...
        $query="SELECT idPrestamo, alumno, DATE_FORMAT(fecha ,'%d/%m/%Y %h:%i %p') as fecha, herramientas, estatus from tbhistprestamos WHERE alumno='$alumno'";
...
<form class="" action="funcionesBD.php" method="post">
  <button type="submit" name="btnVolverPHerramienta" class="btn btn-outline-primary & centrado" style="width: 250px; height: 40px; font-size: 1.1rem;">Volver</button>
</form>
</div>
</div>
