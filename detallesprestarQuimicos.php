...
<table class="table table-striped table-hover" style="text-align: center;">
    <thead>
        ...
        <th style="width:100px;text-align:center;vertical-align: middle;">Estatus</th>
    </thead>
    <tbody>
      <?php
        include("conexion.php");
        ...
        $query="SELECT idPrestamo, alumno, DATE_FORMAT(fecha ,'%d/%m/%Y %h:%i %p') as fecha, quimico, estatus from tbhistprestamosquimi WHERE alumno='$alumno'";
       ...
       <?php
         ...
         <td style="width:200px;height:25px;text-align:center;vertical-align: middle;"><?php echo $row['estatus']; } ?></td>
       </tr>
       <?php
...
<form class="" action="funcionesBD.php" method="post">
  <button type="submit" name="btnVolverPQuimico" class="btn btn-outline-primary & centrado" style="width: 250px; height: 40px; font-size: 1.1rem;">Volver</button>
</form>
</div>
</div>
